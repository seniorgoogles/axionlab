...
class FashionMnist(object):
    ...
    def __do_preprocessing__(self):
        ...
        train_dataset = datasets.FashionMNIST('../tmp/dataset/fashionmnist', train=True, download=True, transform=transform)
        test_dataset = datasets.FashionMNIST('../tmp/dataset/fashionmnist', train=False, transform=transform)
